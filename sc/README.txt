SHAKCAST SERVER INFORMATION -- UNIX VERSION
===========================================
...
or the documentation at:
  ...
  http://www.shakecast.org/documentation/user/install/unix_install.html


If you are upgrading from a previous version, please see the file

  unix_upgrade.txt

or the documentation at

  http://www.shakecast.org/documentation/user/install/unix_upgrade.html

ShakeCast Software Disclaimer and License
=========================================
